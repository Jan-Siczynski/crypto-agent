...
Fetches current prices of BTC, ETH, and SOL from CoinGecko
Fetches trending coins on the market
Fetches global market data (market cap, BTC dominance, volume)
Generates a professional daily market report in Markdown
...
bashgit clone https://github.com/Jan-Siczynski/crypto-agent.git
cd crypto-agent
2. Install dependencies
bashpip install -r requirements.txt
3. Configure API key
Create a config.py file in the project folder:
pythonANTHROPIC_API_KEY = "sk-ant-your-key-here"
...
VariableDescriptionANTHROPIC_API_KEYYour Anthropic API key
📦 Requirements
anthropic
requests
Install with:
